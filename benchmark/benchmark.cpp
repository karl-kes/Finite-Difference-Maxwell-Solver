...
// Grid::update_H and Grid::update_E at src/Classes/Grid/grid.cpp.
//
...
// median_ms runs the kernels straight. The CMake target `benchmark_serial`
// below exposes that.
...
int main( int argc, char* argv[] ) {
    ...
    std::cout << "    build `benchmark_serial` (no -fopenmp) for a true serial baseline.\n";
